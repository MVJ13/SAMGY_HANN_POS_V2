...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereCategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct wherePrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereSortOrder($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct query()
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct active() {@see App\Models\ExtraProduct::scopeActive()}
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ExtraProduct>|ExtraProduct timeout(int $seconds)
     ...
     */
    class ExtraProduct extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property array|null $discount_persons
     * @property float $discount_amount
     * @property float $discount_percent
     * @property float $subtotal
     * @property array|null $extra_items
     * @property array|null $addons
     * @property array $packages
     * @property mixed $total_people
     * @property int $id
     * @property-read mixed $receipt_number
     * @property-read mixed $package_summary
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereTotalPeople($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePackages($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereAddons($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereExtraItems($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereSubtotal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereDiscountPercent($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereDiscountAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereDiscountPersons($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereTotal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePayment($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereAmountReceived($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereChangeGiven($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order active() {@see App\Models\Order::scopeActive()}
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order completed() {@see App\Models\Order::scopeCompleted()}
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order cancelled() {@see App\Models\Order::scopeCancelled()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @property-read mixed $is_available_now
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereCost($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereReorderLevel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereIsExtra($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereSellingPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereAvailableFrom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereAvailableUntil($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product extras() {@see App\Models\Product::scopeExtras()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<StockMovement>|StockMovement whereProductName($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<StockMovement>|StockMovement whereUnitCost($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockMovement>|StockMovement wherePreviousStock($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockMovement>|StockMovement whereNewStock($value)
