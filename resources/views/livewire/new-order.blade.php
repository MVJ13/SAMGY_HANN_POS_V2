<div x-data="{
    ...
    {{-- Flash / Error (Alpine-driven inside wire:ignore so re-renders never touch it) --}}
    ...
    <div class="pos3-layout">
        ...
        <div class="pos3-col pos3-left">
            ...
            <div class="pos3-panel">
                ...
                <div class="pos3-pkg" :class="pkgs.{{ $pkg['key'] }} > 0 ? 'pos3-pkg-on' : ''">
                    <div class="pos3-pkg-left">
                        <div class="pos3-pkg-badge" style="background:{{ $pkg['accent'] }}22;color:{{ $pkg['accent'] }};border:1.5px solid {{ $pkg['accent'] }}44;">{{ $pkg['label'] }}</div>
                        <div class="pos3-pkg-price">₱{{ $pkg['price'] }}<span class="pos3-pkg-unit">/pax</span></div>
                    </div>
                    <div class="pos3-pkg-right">
                        <button class="pos3-qbtn pos3-qbtn-minus" type="button"
                                @click="pkgs.{{ $pkg['key'] }} = Math.max(0,(pkgs.{{ $pkg['key'] }}||0)-1)">−</button>
                        <span class="pos3-qval" x-text="pkgs.{{ $pkg['key'] }} || 0"></span>
                        <button class="pos3-qbtn pos3-qbtn-plus" type="button"
                                @click="pkgs.{{ $pkg['key'] }} = (pkgs.{{ $pkg['key'] }}||0)+1">+</button>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="pos3-panel">
                ...
                <div class="pos3-addon" :class="addons.{{ $addon['key'] }} > 0 ? 'pos3-addon-on' : ''">
                    <span class="pos3-addon-icon">{{ $addon['emoji'] }}</span>
                    <span class="pos3-addon-name">{{ $addon['label'] }}</span>
                    <div class="pos3-addon-ctrl">
                        ...
                        <span class="pos3-qval" x-text="addons.{{ $addon['key'] }} || 0"></span>
