<div x-data="{
     ...
     }" @open-receipt.window="show($event.detail.order)" @keydown.escape.window="close()">

    <h2 style="margin-bottom:20px;color:#ff6b6b;">Receipts</h2>
    <p style="color:#999;margin-bottom:20px;">All order receipts for easy bookkeeping. Click a receipt to view details
        or mark as paid.</p>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <template x-teleport="body">
            <div x-show="open" x-transition:enter="transition ease-out duration-150"
                ...
                x-transition:leave-end="opacity-0" class="modal-backdrop" @click.self="close()" style="display:none;">
                ...
                <div class="modal-box receipt-modal" @click.stop>
                    ...
                    <template x-if="order">
                        <div>
                            <div id="print-area"
                                style="background:#fff;color:#000;padding:30px;border-radius:8px;margin:20px 0;">
                                <div class="receipt-paper">
                                    <div class="receipt-header">
                                        <div class="receipt-title">SAMGY HANN199</div>
                                        <div>#9 Magsaysay Drive,</div>
                                        <div>East Tapinac,</div>
                                        <div>Olongapo City, Zambales</div>
                                    ...
                                    <div
                                        style="border-top:1px dashed #000;border-bottom:1px dashed #000;padding:15px 0;margin:15px 0;">
                                        ...
                                        <template x-for="pkg in order.packages" :key="pkg.name">
                                            <div>
                                                ...
                                                <div class="receipt-line" style="margin-left:20px;">
                                                    <span
                                                        x-text="pkg.people + (pkg.people == 1 ? ' person' : ' people') + ' × ₱' + pkg.price"></span>
                                                    <span
                                                        x-text="'₱' + (pkg.people * pkg.price).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                                </div>
                                            </div>
                                        </template>
                                            ...
                                            <div style="margin-top:10px;padding-top:10px;border-top:1px solid #ccc;">
                                                <template x-for="addon in order.addons" :key="addon.name">
                                                    <div>
                                                        <div class="receipt-line">
                                                            <span
                                                                x-text="addon.name + ' (₱' + addon.price + '/person):'"></span>
                                                            <span></span>
                                                        </div>
                                                        <div class="receipt-line" style="margin-left:20px;">
                                                            <span
                                                                x-text="addon.people + (addon.people == 1 ? ' person' : ' people') + ' × ₱' + addon.price"></span>
                                                            <span
                                                                x-text="'₱' + (addon.people * addon.price).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                                        </div>
                                                    </div>
                                                </template>
                                            </div>
                                            ...
                                            <div style="margin-top:10px;padding-top:10px;border-top:1px solid #ccc;">
                                                ...
                                                <template x-for="extra in order.extra_items" :key="extra.name">
                                                    <div class="receipt-line" style="margin-left:20px;">
                                                        ...
                                                        <span
                                                            x-text="'₱' + Number(extra.amount).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                                    </div>
                                                </template>
                                            </div>
                                        </template>
                                        ...
                                        <div class="receipt-line"
                                            ...
                                            <span>Subtotal:</span>
                                            <span
                                                x-text="'₱' + Number(order.subtotal).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                        </div>
                                        <template x-if="order.discount_percent > 0">
                                            <div class="receipt-line" style="color:green;">
                                                ...
                                                <span
                                                    x-text="'-₱' + Number(order.discount_amount).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                            </div>
                                        </template>
                                    </div>
                                    ...
                                    <div class="receipt-total">
                                        <div class="receipt-line">
                                            ...
                                            <span
                                                x-text="'₱' + Number(order.total).toLocaleString('en-PH', {minimumFractionDigits:2,maximumFractionDigits:2})"></span>
                                        </div>
                                    </div>
...
</div><?php /**PATH C:\Users\Mark\samgyeopsal-pos\resources\views/livewire/receipts.blade.php ENDPATH**/ ?>