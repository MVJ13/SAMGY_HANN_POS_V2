<div x-data="{
    ...
    <div class="inv-overview">
        <div class="inv-card" style="border-left:5px solid #2196f3;">
            ...
            <div class="inv-card-value" style="color:#2196f3;"><?php echo e($products->count()); ?></div>
        </div>
        ...
        <div class="inv-card" style="border-left:5px solid #4caf50;">
            ...
            <div class="inv-card-value" style="color:#4caf50;"><?php echo e($healthyStock->count()); ?></div>
        </div>
    </div>
