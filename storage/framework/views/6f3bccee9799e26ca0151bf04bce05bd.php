<div x-data="{
    ...
    allProducts: <?php echo e(json_encode($products->map(fn($p) => [
        'id'            => $p->id,
        'name'          => $p->name,
        'category'      => $p->category,
        'stock'         => (float) $p->stock,
    ...
    movements: <?php echo e(json_encode($movements->map(fn($m) => [
        'id'             => $m->id,
...
<?php /**PATH C:\Users\Mark\samgyeopsal-pos - Copy\resources\views/livewire/inventory.blade.php ENDPATH**/ ?>